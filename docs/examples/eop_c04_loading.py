...
if __name__ == '__main__':
    ...
    rastro.set_global_eop_from_default_c04("Hold", True)
    ...
    eop = rastro.set_global_eop_from_default_c04("Zero", True)
    ...
    # rastro.set_global_eop_from_c04_file(filepath, "Error", False)